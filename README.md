...
deploy a BlazeMeter profile for your application, autoconfiguring Drupal with latest BlazeMeter module. 
Any new modules you add or files uploaded to the site
should be placed under sites directory. If you want to reconfigure Drupal
...
Create a php-5.3 application with MySQL and Cron support.
    ...
    rhc app create drupal php-5.3 mysql cron --from-code=git://github.com/tamerzg/blazemeter-openshift.git
...
.openshift/install_profiles/blazemeter_profile - Drupal BlazeMeter profile
